...
def main():
    ...
    split_points = {f"blocks.{(i + 1) * (12 // NUM_STAGES)}": PipeSplitWrapper.SplitPoint.BEGINNING for i in range(NUM_STAGES - 1)}
    # split_points = {'blocks.2.mlp': PipeSplitWrapper.SplitPoint.END,
    #                 'blocks.5.mlp': PipeSplitWrapper.SplitPoint.END,
    #                 'blocks.8.mlp': PipeSplitWrapper.SplitPoint.END,}
